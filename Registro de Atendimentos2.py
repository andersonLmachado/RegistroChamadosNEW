...
class RegistroAtendimentos(Ctk.CTk):
    def __init__(self):
        ...
        self.label_titulo = Ctk.CTkLabel(self, text="Registro de Atendimentos", font=("Helvetica", 16, "bold"))
        ...
        ## Declarar empresa ##
        self.label_suzano = Ctk.CTkLabel(self, text=f"Suzano", font=("Helvetica", 16, "bold"))

        ## Declarar botões ##
        self.btn_suzano1 = Ctk.CTkButton(master=self, text="Cadastro Omnilink", command=self.SuzanoContador1)
        self.label_suzano1 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano2 = Ctk.CTkButton(master=self, text="Verificar Espelhamento", command=self.SuzanoContador2)
        self.label_suzano2 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano3 = Ctk.CTkButton(master=self, text="Trocar Rastreador", command=self.SuzanoContador3)
        self.label_suzano3 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano4 = Ctk.CTkButton(master=self, text="Voltar para PNA", command=self.SuzanoContador4)
        self.label_suzano4 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano5 = Ctk.CTkButton(master=self, text="Treinamento", command=self.SuzanoContador5)
        self.label_suzano5 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano6 = Ctk.CTkButton(master=self, text="Cadastro", command=self.SuzanoContador6)
        self.label_suzano6 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano7 = Ctk.CTkButton(master=self, text="Dúvidas", command=self.SuzanoContador7)
        self.label_suzano7 = Ctk.CTkLabel(master=self, text="0")
        
        self.btn_suzano8 = Ctk.CTkButton(master=self, text="Outros", command=self.SuzanoContador8)
        self.label_suzano8 = Ctk.CTkLabel(master=self, text="0")
